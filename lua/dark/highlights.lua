...
hl.common = {
    ...
    CurSearch = {fg = c.bg0, bg = c.orange}, -- Current search from theme.json
    IncSearch = {fg = c.bg0, bg = c.orange}, -- Incremental search
    Search = {fg = c.bg0, bg = c.bg_yellow}, -- Search highlight from theme.json
    Substitute = {fg = c.bg0, bg = c.green},
    MatchParen = {fg = c.none, bg = c.grey},
    NonText = {fg = c.grey},
    Whitespace = {fg = c.grey},
    SpecialKey = {fg = c.grey},
    Pmenu = {fg = c.fg, bg = c.bg0}, -- Popup menu background pure black
    PmenuSbar = {fg = c.none, bg = c.bg0},
    PmenuSel = {fg = c.fg, bg = c.bg_blue}, -- Selected item with blue bg from theme.json
    ...
    StatusLine = {fg = c.fg, bg = c.bg1}, -- Match theme.json statusline
    StatusLineTerm = {fg = c.fg, bg = c.bg1},
    StatusLineNC = {fg = c.grey, bg = c.bg0}, -- Inactive statusline
    StatusLineTermNC = {fg = c.grey, bg = c.bg0},
    TabLine = {fg = c.fg, bg = c.bg0}, -- Match theme.json tab colors
    TabLineFill = {fg = c.grey, bg = c.bg0},
    TabLineSel =  {fg = c.bg0, bg = c.fg}, -- Active tab contrast
    WinSeparator = {fg = c.bg3}, -- Window separator from theme.json
    Visual = {bg = c.bg_blue}, -- Selection bg from theme.json
    ...
    FloatBorder = {fg = c.bg3, bg = c.bg0}, -- Border color from theme.json
    NormalFloat = {fg = c.fg, bg = c.bg0}, -- Floating window pure black bg
}

hl.syntax = {
    String = {fg = c.green, fmt = cfg.code_style.strings}, -- Pink/magenta #E394DC for strings
    Character = {fg = c.green}, -- Same as strings
    Number = {fg = c.number or c.cyan}, -- Cyan #82D2CE for numbers  
    Float = {fg = c.number or c.cyan}, -- Cyan for floats
    Boolean = {fg = c.constant or c.cyan}, -- Cyan for booleans
    Type = {fg = c.orange}, -- Orange #EFB080 for types
    Structure = {fg = c.orange}, -- Orange for structures
    StorageClass = {fg = c.orange}, -- Orange for storage classes
    Identifier = {fg = c.fg, fmt = cfg.code_style.variables}, -- Default foreground #D6D6DD for variables
    Constant = {fg = c.constant or c.yellow}, -- Yellow #F8C762 for constants
    PreProc = {fg = c.purple}, -- Purple #AAA0FA for preprocessor
    PreCondit = {fg = c.purple}, -- Purple for preprocessor conditionals
    Include = {fg = c.blue}, -- Blue for includes/imports to match target
    Keyword = {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan #83D6C5 for keywords
    Define = {fg = c.purple}, -- Purple for defines
    Typedef = {fg = c.orange}, -- Orange for typedefs
    Exception = {fg = c.cyan}, -- Cyan for exceptions
    Conditional = {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan for conditionals
    Repeat = {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan for loops
    Statement = {fg = c.cyan}, -- Cyan for statements
    Macro = {fg = c.purple}, -- Purple for macros
    Error = {fg = c.red}, -- Red for errors
    Label = {fg = c.cyan}, -- Cyan for labels
    Special = {fg = c.green}, -- Orange for special chars
    SpecialChar = {fg = c.green}, -- Orange for special chars
    Function = {fg = c.yellow, fmt = cfg.code_style.functions}, -- Yellow/gold #EBC88D for functions
    Operator = {fg = c.fg}, -- Default fg for operators
    Title = {fg = c.cyan}, -- Cyan for titles
    Tag = {fg = c.green}, -- Pink/magenta for tags
    Delimiter = {fg = c.fg}, -- Default fg for delimiters
    Comment = {fg = c.grey, fmt = cfg.code_style.comments}, -- Grey #6D6D6D for comments
    SpecialComment = {fg = c.grey, fmt = cfg.code_style.comments}, -- Grey for special comments
    Todo = {fg = c.red, fmt = cfg.code_style.comments} -- Red for todos
}
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@constant"] = {fg = c.yellow, fmt = cfg.code_style.constants}, -- Yellow for constants
        ["@constant.builtin"] = {fg = c.yellow, fmt = cfg.code_style.constants}, -- Yellow for built-in constants
        ["@constant.macro"] = {fg = c.yellow, fmt = cfg.code_style.constants}, -- Yellow for macro constants
        ["@constructor"] = {fg = c.orange, fmt = "bold"}, -- Orange for constructors
        ...
        ["@error"] = colors.Fg,
        ["@function"] = {fg = c.orange, fmt = cfg.code_style.functions}, -- orange/gold #EBC88D for functions
        ["@function.builtin"] = {fg = c.cyan, fmt = cfg.code_style.functions}, -- orange/gold for built-in functions
        ["@function.macro"] = {fg = c.orange, fmt = cfg.code_style.functions}, -- orange/gold for function macros
        ["@function.method"] = {fg = c.orange, fmt = cfg.code_style.functions}, -- Yellow/gold for methods
        ["@keyword"] = {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan #83D6C5 for keywords
        ["@keyword.conditional"] = {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan for conditional keywords
        ["@keyword.directive"] = {fg = c.cyan}, -- Cyan for directives
        ["@keyword.exception"] = {fg = c.cyan}, -- Cyan for exception keywords
        ["@keyword.function"] = {fg = c.cyan, fmt = cfg.code_style.functions}, -- Cyan for function keywords
        ["@keyword.import"] = {fg = c.cyan}, -- Blue for import keywords to match target
        ["@keyword.operator"] =  {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan for operator keywords
        ["@keyword.repeat"] = {fg = c.cyan, fmt = cfg.code_style.keywords}, -- Cyan for repeat keywords
        ["@label"] = colors.Red,
        ...
        ["@none"] = colors.Fg,
        ["@number"] = {fg = c.yellow}, -- Yellow for numbers
        ["@number.float"] = {fg = c.yellow}, -- Yellow for float numbers
        ["@operator"] = colors.Fg,
        ...
        ["@warning"] = colors.Fg,
        ["@danger"] = colors.Fg,
        ["@type"] = {fg = c.orange}, -- Orange for types
        ["@type.builtin"] = {fg = c.orange}, -- Orange for built-in types
        ["@variable"] = {fg = c.white, fmt = cfg.code_style.variables}, -- Light blue for variables
        ["@variable.builtin"] = {fg = c.white, fmt = cfg.code_style.variables}, -- Light blue for built-in variables
        ["@variable.member"] = {fg = c.white}, -- Light blue for member variables
        ["@variable.parameter"] = {fg = c.white}, -- Orange for parameters
        ...
        ["@field"] = colors.Cyan,
        ["@float"] = colors.Orange,
        ["@include"] = {fg = c.blue}, -- Blue for includes
    ...
    hl.treesitter = {
        ...
        TSFunction = {fg = c.yellow, fmt = cfg.code_style.functions}, -- Yellow for functions
        TSFuncBuiltin = {fg = c.cyan, fmt = cfg.code_style.functions},
        TSFuncMacro = {fg = c.cyan, fmt = cfg.code_style.functions},
        TSInclude = {fg = c.blue}, -- Blue for includes
        ...
        TSWarning = colors.Fg,
        TSDanger = colors.Fg,
        TSType = {fg = c.orange}, -- Orange for types
...
hl.plugins.cmp = {
    CmpItemAbbr = {fg = c.fg}, -- Default fg for completion text
    CmpItemAbbrDeprecated = { fg = c.light_grey, fmt = "strikethrough" },
    CmpItemAbbrMatch = {fg = c.purple}, -- Purple for matched text
    CmpItemAbbrMatchFuzzy = { fg = c.purple, fmt = "underline" }, -- Purple for fuzzy matches
    CmpItemMenu = {fg = c.light_grey}, -- Light grey for menu text
    CmpItemKind = { fg = c.orange, fmt = cfg.cmp_itemkind_reverse and "reverse" }, -- Orange for kind
}

hl.plugins.blink = {
    BlinkCmpLabel = {fg = c.fg}, -- Default fg for completion labels
    BlinkCmpLabelDeprecated = { fg = c.light_grey, fmt = "strikethrough" },
    BlinkCmpLabelMatch = {fg = c.purple}, -- Purple for matched text
    BlinkCmpDetail = {fg = c.light_grey}, -- Light grey for details
    BlinkCmpKind = { fg = c.orange }, -- Orange for kind
}
...
hl.plugins.whichkey = {
    WhichKey = {fg = c.purple}, -- Purple for key bindings
    WhichKeyDesc = {fg = c.fg}, -- Default fg for descriptions
    WhichKeyGroup = {fg = c.orange}, -- Orange for groups
    WhichKeySeparator = {fg = c.grey} -- Grey for separators
}
...
hl.plugins.hop = {
    HopNextKey = {fg = c.red, fmt = "bold"}, -- Error red for primary target
    HopNextKey1 = {fg = c.cyan, fmt = "bold"}, -- Cyan for secondary target
    HopNextKey2 = {fg = util.darken(c.blue, 0.7)}, -- Darker blue for tertiary
    HopUnmatched = {fg = c.grey}, -- Comments color for unmatched
}
...
hl.plugins.gitsigns = {
    GitSignsAdd = {fg = c.dark_cyan}, -- Git added color from theme.json (#15ac91)
    GitSignsAddLn = {fg = c.dark_cyan},
    GitSignsAddNr = {fg = c.dark_cyan},
    GitSignsChange = {fg = c.blue}, -- Git modified color from theme.json (#1981ef)
    GitSignsChangeLn = {fg = c.blue},
    GitSignsChangeNr = {fg = c.blue},
    GitSignsDelete = {fg = c.red}, -- Git deleted color from theme.json (#f14c4c)
    GitSignsDeleteLn = {fg = c.red},
    GitSignsDeleteNr = {fg = c.red}
}

hl.plugins.neo_tree = {
    NeoTreeNormal = { fg = c.fg, bg = cfg.transparent and c.none or c.bg0 }, -- Pure black bg from theme.json
    NeoTreeNormalNC = { fg = c.fg, bg = cfg.transparent and c.none or c.bg0 },
    NeoTreeVertSplit = { fg = c.bg3, bg = cfg.transparent and c.none or c.bg0 }, -- Border color #383838
    NeoTreeWinSeparator = { fg = c.bg3, bg = cfg.transparent and c.none or c.bg0 },
    NeoTreeEndOfBuffer = { fg = cfg.ending_tildes and c.bg2 or c.bg0, bg = cfg.transparent and c.none or c.bg0 },
    NeoTreeRootName = { fg = c.orange, fmt = "bold" }, -- Orange for root name
    NeoTreeGitAdded = {fg = c.dark_cyan}, -- Git added color from theme.json
    NeoTreeGitDeleted = {fg = c.red}, -- Git deleted color
    NeoTreeGitModified = {fg = c.blue}, -- Git modified color from theme.json  
    NeoTreeGitConflict = { fg = c.red, fmt = "bold" },
    NeoTreeGitUntracked = { fg = c.dark_cyan }, -- Untracked files
    NeoTreeIndentMarker = {fg = c.bg3}, -- Subtle indent markers
    NeoTreeSymbolicLinkTarget = {fg = c.purple}, -- Purple for symlinks
    NeoTreeDirectoryName = {fg = c.blue}, -- Light blue for directories
    NeoTreeDirectoryIcon = {fg = c.blue}, -- Light blue for directory icons
    NeoTreeFileName = {fg = c.fg}, -- Default foreground for files
    NeoTreeFileIcon = {fg = c.fg}, -- Default foreground for file icons
}
...
hl.plugins.nvim_tree = {
    NvimTreeNormal = { fg = c.fg, bg = cfg.transparent and c.none or c.bg0 }, -- Pure black bg
    NvimTreeNormalFloat = { fg = c.fg, bg = cfg.transparent and c.none or c.bg0 },
    NvimTreeVertSplit = { fg = c.bg3, bg = cfg.transparent and c.none or c.bg0 }, -- Border color #383838
    NvimTreeEndOfBuffer = { fg = cfg.ending_tildes and c.bg2 or c.bg0, bg = cfg.transparent and c.none or c.bg0 },
    NvimTreeRootFolder = { fg = c.orange, fmt = "bold" }, -- Orange for root
    NvimTreeGitDirty = {fg = c.blue}, -- Modified files in blue 
    NvimTreeGitNew = {fg = c.dark_cyan}, -- New files in green
    NvimTreeGitDeleted = {fg = c.red}, -- Deleted files in red
    NvimTreeSpecialFile = { fg = c.yellow, fmt = "underline" }, -- Special files in yellow
    NvimTreeIndentMarker = {fg = c.bg3}, -- Subtle indent markers
    NvimTreeImageFile = { fg = c.purple }, -- Purple for images
    NvimTreeSymlink = {fg = c.purple}, -- Purple for symlinks
    NvimTreeFolderName = {fg = c.blue}, -- Light blue for folders
    NvimTreeFolderIcon = {fg = c.blue}, -- Light blue for folder icons
    NvimTreeOpenedFolderName = {fg = c.blue, fmt = "bold"}, -- Bold for opened folders
}

hl.plugins.telescope = {
    TelescopeBorder = {fg = c.bg3}, -- Use border color from theme.json (#383838)
    TelescopePromptBorder = {fg = c.bg3}, -- Consistent border
    TelescopeResultsBorder = {fg = c.bg3}, -- Consistent border
    TelescopePreviewBorder = {fg = c.bg3}, -- Consistent border
    TelescopeMatching = { fg = c.orange, fmt = "bold" }, -- Orange for matches
    TelescopePromptPrefix = {fg = c.purple}, -- Purple prompt prefix
    TelescopeSelection =  { bg = c.bg_blue }, -- Selection bg from theme.json
    TelescopeSelectionCaret = {fg = c.fg} -- Default fg for caret
}

hl.plugins.snacks = {
    -- Dashboard
    SnacksDashboardHeader = {fg = c.purple}, -- Purple for header
    SnacksDashboardFooter = { fg = c.grey, fmt = "italic" }, -- Grey for footer
    SnacksDashboardSpecial = { fg = c.orange, fmt = "bold" }, -- Orange for special
    SnacksDashboardDesc = {fg = c.fg}, -- Default fg for descriptions
    SnacksDashboardIcon = {fg = c.blue}, -- Blue for icons
    SnacksDashboardKey = {fg = c.yellow}, -- Yellow for keys
...
hl.plugins.dashboard = {
    DashboardShortCut = {fg = c.yellow}, -- Yellow for shortcuts
    DashboardHeader = {fg = c.purple}, -- Purple for header
    DashboardCenter = {fg = c.fg}, -- Default fg for center content
    DashboardFooter = { fg = c.grey, fmt = "italic"} -- Grey for footer
}
...
hl.plugins.indent_blankline = {
    IndentBlanklineIndent1 = {fg = c.blue}, -- Light blue
    IndentBlanklineIndent2 = {fg = c.green}, -- Pink/magenta
    IndentBlanklineIndent3 = {fg = c.cyan}, -- Cyan
    IndentBlanklineIndent4 = {fg = c.light_grey}, -- Light grey
    IndentBlanklineIndent5 = {fg = c.purple}, -- Purple
    IndentBlanklineIndent6 = {fg = c.red}, -- Red
    IndentBlanklineChar = { fg = c.bg3, fmt = "nocombine" }, -- Subtle from theme.json (#383838)
    IndentBlanklineContextChar = { fg = c.grey, fmt = "nocombine" }, -- Comments color
    IndentBlanklineContextStart = { sp = c.grey, fmt = "underline" },
    IndentBlanklineContextSpaceChar = { fmt = "nocombine" },

    -- Ibl v3
    IblIndent = { fg = c.bg3, fmt = "nocombine" }, -- Subtle indent guides
    IblWhitespace = { fg = c.grey, fmt = "nocombine" }, -- Comments color for whitespace
    IblScope = { fg = c.grey, fmt = "nocombine" }, -- Comments color for scope
}
...
hl.plugins.mini = {
    ...
    MiniNotifyTitle = {fg = c.fg}, -- Use main fg color from theme.json
...
function M.setup()
        ...
        if color_name:sub(1, 1) == '$' then
            ...
            if not color_name then
                vim.schedule(function()
                    vim.notify('dark.nvim: unknown color "' .. name .. '"', vim.log.levels.ERROR, { title = "dark.nvim" })
                end)
                return ""
            end
        end
    ...
    for group_name, group_settings in pairs(vim.g.dark_config.highlights) do
